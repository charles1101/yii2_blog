    ...
    <div class="leftpanel">
        <div class="leftpanelinner">
            ...
            <div class="leftpanel-userinfo collapse" id="loguserinfo">
                ...
                <address>上海市松江区</address>
                <h5 class="sidebar-title">联系方式</h5>
                <ul class="list-group">
                    <li class="list-group-item">
                        <label class="pull-left">邮箱</label>
                        <span class="pull-right">798221366@qq.com</span>
                    </li>
                    <li class="list-group-item">
                        <label class="pull-left">电话</label>
                        <span class="pull-right">021-57882319</span>
                    </li>
                    <li class="list-group-item">
                        <label class="pull-left">手机</label>
                        <span class="pull-right">+86 188-1737-9993</span>
                    </li>
                    <li class="list-group-item">
